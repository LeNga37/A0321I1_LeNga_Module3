...
(3,'Phan Nhat Anh','1992/09/12', '016243912','0981357368','nhatanh@gmail.com','Quang Ninh'),
...
(2,'Nguyen Cong Phuong','1997/11/26', '125028462','07345129021','nguyencongphuong@gmail.com','Quang Tri'),
...
VALUES
('Villa',300,4,15,20000000,1,1,'moi'),
('Villa',230,2,9,350000,3,1,'moi'),
('House',90,3,8,2500000,2,2,'moi'),
('Room',45,1,3,200000,4,3,'moi'),
('Room',60,1,4,200000,4,3,'moi');

-- HOP DONG
INSERT INTO hop_dong (id_nhan_vien, id_khach_hang, id_dich_vu, ngay_lam_hop_dong, ngay_ket_thuc, tien_dat_coc, tong_tien)
VALUES
(1, 2, 1, '2020/09/03','2021/09/03',2000000,20000000),
...
(7, 8, 5, '2021/09/20','2021/09/20',200000,200000),
(15, 2, 1, '2021/12/12','2022/12/12',4000000,20000000),
(10, 5, 3, '2021/08/15','2021/09/15',500000,2500000),
(10, 5, 3, '2021/02/15','2021/03/15',500000,2500000),
(1, 8, 5, '2021/03/14','2021/03/14',200000,200000);
...
VALUES
(1,2,1), (2,1,3), (3,3,1), (4,4,10), (5,5,1), (6,3,3);